...
public class Movement3D : MonoBehaviour
{
    ...
    IEnumerator IPlayerRotate(float directionX, float directionZ)
    {
        //동쪽
        ...
        {
            Vector3 to = new Vector3(0.0f, rotateAngle + rotateHalfAngle, 0.0f);
            this.transform.eulerAngles = Vector3.Lerp(this.transform.rotation.eulerAngles, to, Time.deltaTime * speed);
        }
        //남쪽
        else if (directionX == 0 && directionZ < 0)
        {
            Vector3 to = new Vector3(0.0f, rotateAngle * 2, 0.0f);
            this.transform.eulerAngles = Vector3.Lerp(this.transform.rotation.eulerAngles, to, Time.deltaTime * speed);
        }
        //남서쪽
        else if (directionX < 0 && directionZ < 0)
        {
            Vector3 to = new Vector3(0.0f, rotateAngle * 2 + rotateHalfAngle, 0.0f);
            this.transform.eulerAngles = Vector3.Lerp(this.transform.rotation.eulerAngles, to, Time.deltaTime * speed);
        }
        //서쪽
        else if (directionX < 0 && directionZ == 0)
        ...
        {
            Vector3 to = new Vector3(0.0f, rotateAngle * 3 + rotateHalfAngle, 0.0f);
            this.transform.eulerAngles = Vector3.Lerp(this.transform.rotation.eulerAngles, to, Time.deltaTime * speed);
        }
        //북쪽
        else if (directionX == 0 && directionZ > 0)
        {
            Vector3 to = new Vector3(0.0f, rotateAngle*4, 0.0f);
            this.transform.eulerAngles = Vector3.Lerp(this.transform.rotation.eulerAngles, to, Time.deltaTime * speed);
        }
        //북동쪽
        else if (directionX > 0 && directionZ > 0)
        {
            Vector3 to = new Vector3(0.0f, rotateHalfAngle, 0.0f);
            this.transform.eulerAngles = Vector3.Lerp(this.transform.rotation.eulerAngles, to, Time.deltaTime * speed);
        }
    ...
    {
        StartCoroutine(IPlayerRotate(directionX, directionZ));
    }
}
